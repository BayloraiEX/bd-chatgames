                        ...
                        if v.type == "dices" then
                            if #v.num > 1 then
                                ...
                                for a, b in pairs(v.num) do
                                    html = html .. "<img \" width=\"75px\" height=\"75px\" src=\"imagez/dice_".. b.dicenum ..".png\">"
                                end
                            else
                                html = html .. "<span style=\"position: absolute; left: ".. xxx * 94 .."%;top: ".. yyy * 100 .."%;\">"
                                html = html .. "<img \" width=\"75px\" height=\"75px\" src=\"imagez/dice_".. v.num[1].dicenum ..".png\">"    
                            end
                            html = html .. "</img></span>"
                        elseif v.type == "rps" then
                            html = html .. "<span style=\"position: absolute; left: ".. xxx * 94 .."%;top: ".. yyy * 100 .."%;\">"
                            html = html .. "<img \" width=\"75px\" height=\"75px\" src=\"imagez/option_".. v.num ..".png\">"    
                            html = html .. "</img></span>"
                        elseif v.type == "shoot" then
                            html = html .. "<span style=\"position: absolute; left: ".. xxx * 94 .."%;top: ".. yyy * 100 .."%;\">"
                            html = html .. "<img \" width=\"75px\" height=\"75px\" src=\"imagez/shoot_".. v.num ..".png\">"
                            html = html .. "</img></span>"
                        elseif v.type == "coinflip" then
                            html = html .. "<span style=\"position: absolute; left: ".. xxx * 94 .."%;top: ".. yyy * 100 .."%;\">"
                            html = html .. "<img \" width=\"75px\" height=\"75px\" src=\"imagez/coinflip_".. v.num ..".png\">"
                            html = html .. "</img></span>"
                        end
                    end
                end
...
RegisterNetEvent("bd-chatgames:ToggleDisplay")
AddEventHandler("bd-chatgames:ToggleDisplay", function(playerId, number, typ)
	diceDisplaying[tonumber(playerId)] = {num = number, time = GetGameTimer() + displayTime, type = typ}
end)

RegisterNetEvent("bd-chatgames:ToggleDiceAnim")
AddEventHandler("bd-chatgames:ToggleDiceAnim", function()
